...
export default async function handler(req, res) {
  ...
  const PRICE_IDS = {
    ...
    collective: process.env.PRICE_COLLECTIVE,
  };
  ...
  const cancelUrls = {
    unfinished: 'https://lastwordletters.com/unfinished-conversation',
    collective: 'https://lastwordletters.com/one-voice-many-hearts',
  };
  ...
  try {
    const params = {
      ...
      'cancel_url': cancelUrls[packageId] || 'https://lastwordletters.com/app',
    };

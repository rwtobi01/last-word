...
- ONLY use details and facts that appear in the two fields above. Do not invent specific times, places, memories, conversations, or any detail not explicitly provided. If something was not shared, write around the absence — do not fill it in.
- Use their actual words where powerful — if they wrote something specific, let it land in the paragraph
...
- Every sentence must be earned by what they shared — nothing generic, nothing assumed, nothing invented
...
function buildEmailHTML({ paragraph }) {
  return `<!DOCTYPE html>
<html lang="en">
